...
baseline$alcoolCut[which(baseline$alcool %in% c(3,4,5))] = "3-5"
baseline$alcoolCut[which(baseline$alcool %in% c(6,7,8,9,10))] = "5-10"
baseline$alcoolCut[which(baseline$alcool %in% c(11,12,13,14,16,18,20,32,40,60))] = ">10"
